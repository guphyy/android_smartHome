...
public class Wifi_function extends Activity {
            ...
            switch (view.getId()){
                case R.id.btn_FunctionEnsure:
                    ...
                    if (radioBtnServer.isChecked()){
                        intent.setClass(Wifi_function.this,FuncTcpServer.class);
                        startActivity(intent);
                    }
                    if (radioBtnClient.isChecked()){
                        intent.setClass(Wifi_function.this, FuncTcpClient.class);
                        startActivity(intent);
                    }
                    break;
            }
